...
const Card = () => {
  return (
    <div className="border-2 border-rose-900 rounded-3xl p-6 relative max-w-[400px] mb-10">
      <img
      ...
      <div className="flex items-center">
        ...
        <div className="flex items-end gap-1 ml-6 -mt-8 justify-end">
      ...
      <p className="py-4 text-2xl text-gray-400">Max Contribution: 3.0 BNB</p>
      ...
      <ul className="mt-3">
        ...
        <li className="flex justify-between text-xl font-semibold py-2">
          <span>Liquidity:</span>
      ...
      <div className="flex justify-between items-center border-t pt-4 mt-6">
        <div>
          <p className="text-xl">Sale Starts In:</p>
